...
- qemu-3dfx バイナリは固定せず設定値。既定は build-r
  `/storage/work/kvm98/src/qemu-3dfx-0b399bd-fix/build-r/qemu-system-i386`(md5 9f89d34ebbcb53aabcb70ea7bdcb0599)。
...
4. qemu-3dfx パスを設定に追加: `/opt/mirai98/web/pc98web.json` に
   `"qemu_3dfx": "/storage/work/kvm98/src/qemu-3dfx-0b399bd-fix/build-r/qemu-system-i386"` を入れる
